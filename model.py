...
#Unet with a pretrained backbone
def UNet_pretrained():
	model = Unet(backbone = "convnext_base",
		in_channels = 1,
		num_classes = 1)
	return model
...
class UNet(nn.Module):
    def __init__(self, n_class):
        ...
        # Encoder
        # input: 768x256x3 -.> 284 x 284 x 32
        self.e21 = nn.Conv2d(1, 32, kernel_size=3, padding=1) 
